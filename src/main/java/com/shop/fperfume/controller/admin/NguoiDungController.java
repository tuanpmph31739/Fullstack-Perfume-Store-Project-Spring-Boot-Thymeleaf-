...
//            @RequestParam(required = false) String keyword,    // Tìm kiếm
//            @RequestParam(required = false) String vaiTro,     // Lọc vai trò
//            @RequestParam(required = false) Boolean trangThai, // Lọc trạng thái
//            Model model) {
//
//        Pageable pageable = PageRequest.of(page, size);
//
//        // Gọi service xử lý logic
//        Page<NguoiDung> pageData = service.getAll(keyword, vaiTro, trangThai, pageable);
//
//        model.addAttribute("pageData", pageData);
//        model.addAttribute("currentPage", page);
//        model.addAttribute("totalPages", pageData.getTotalPages());
//
//        // Trả lại giá trị input để hiển thị lại trên form
